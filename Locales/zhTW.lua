...
REP_TXT.elements.tip.REP_ShowAllButton	= "顯示從任務、物品、副本、特定小怪四種方式獲得聲望的方法。"
REP_TXT.elements.name.REP_ShowNoneButton	= REP_TXT.showNone
REP_TXT.elements.tip.REP_ShowNoneButton	= "隱藏從任務、物品、副本、特定小怪四種方式獲得聲望的方法。"
REP_TXT.elements.name.REP_ExpandButton	= REP_TXT.expand
REP_TXT.elements.tip.REP_ExpandButton	= "展開列表中的所有條目，顯示詳細資料，例如任務內容或需要的物品。"
REP_TXT.elements.name.REP_CollapseButton	= REP_TXT.collapse
REP_TXT.elements.tip.REP_CollapseButton	= "折疊列表中的所有條目，隱藏詳細資料。"
REP_TXT.elements.name.REP_SupressNoneFactionButton	= REP_TXT.supressNoneFaction
REP_TXT.elements.tip.REP_SupressNoneFactionButton	= "重新啟用此陣營聲望列表中，被右鍵點擊排除的項目。"
REP_TXT.elements.name.REP_SupressNoneGlobalButton	= REP_TXT.supressNoneGlobal
REP_TXT.elements.tip.REP_SupressNoneGlobalButton	= "重新啟用所有陣營聲望列表中，被右鍵點擊排除的項目。"
