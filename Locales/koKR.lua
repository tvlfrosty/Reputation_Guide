...
REP_TXT.showPvPQuests	= "쇼 PvP 퀘스트"
...
REP_TXT.elements.tip.REP_ShowNonPvPQuestsButton	= "당신의 평판을 개선하기 위해 할 수있는 퀘스트를 보려면이 단추를 선택하십시오."
REP_TXT.elements.name.REP_ShowPvPQuestsButton	= REP_TXT.showPvPQuests
REP_TXT.elements.tip.REP_ShowPvPQuestsButton	= "당신의 평판을 개선하기 위해 할 수있는 PvP 퀘스트를 보려면이 단추를 선택하십시오."
