...
REP_TXT.gainToChat	= "获得声望时，在聊天框显示更完整的信息，取代暴雪预设的声望信息"
REP_TXT.noGuildGain	= "隐藏公会声望"
REP_TXT.suppressOriginalGain	= "不显示暴雪预设的声望信息"
...
REP_TXT.defaultChatFrame	= "使用预设聊天框"
REP_TXT.chatFrame	= "使用聊天框 %d (%s)"
REP_TXT.usingDefaultChatFrame	= "使用预设聊天框"
...
REP_TXT.elements.tip.REP_OrderByStandingCheckBox	= "停用此选项，声望列表按照暴雪预设排序，依资料片和字母顺序排列。\r\n\r\n启用此选项，声望列表按声望等级排序\r\n\r\n要查看|cFFFAA0A0移至閒置|r的阵营声望，停用此选项，然后查看列表底部。"
...
REP_TXT.elements.tip.REP_SupressOriginalGainBox	= "隐藏暴雪预设的声望信息。\r \n如果已经启用了详细的声望信息，勾选这个选项，可以避免聊天框输出重复的信息。"
