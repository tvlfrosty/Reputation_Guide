...
--------------------------------------------------
    ...
    ---- stops after friendly -> honored
		REP_AddMob(1204, 4, 5, "Druid of the Flame", 5, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Cinderweb Spiderling", 5, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Fire Scorpion", 5, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Cinderweb Spinner", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Cinderweb Drone", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Fire Turtle Hatchling", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Flamewaker Animator", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Flamewaker Beast Handler", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Cauterizer", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Flamewaker Centurion", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Forward Guard", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Hound Master", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Pathfinder", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Sentinel", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Taskmaster", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Flamewaker Trainee", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Giant Fire Scorpion", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Harbringer of Flame", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Hell Hound", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Matriarch Fire Turtle", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Molten Surger", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Molten Spewer", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Patriarch Fire Turtle", 15, zone.Firelands)
    REP_AddMob(1204, 4, 5, "Unbound Blazing Elemental", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Unbound Pyrelord", 15, zone.Firelands)
		REP_AddMob(1204, 4, 5, "Unbound Smoldering Elemental", 15, zone.Firelands)
		---- stops after honored -> revered
		REP_AddMob(1204, 4, 6, "Ancient Core Hound", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Blazing Monstrosity", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Flame Archon", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Flamewaker Overseer", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Flamewaker Subjugator", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Kar the Everburning", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Molten Erupter", 50, zone.Firelands)
		REP_AddMob(1204, 4, 6, "Molten Flamefather", 50, zone.Firelands)
    ...
    if(ReputationGuide.AfterBfA) then
      ...
      REP_AddMob(1204, 4, 8, "Baleroc", 400, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Majordomo Staghelm", 400, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Ragnaros", 400, zone.Firelands)
    else
      REP_AddMob(1204, 4, 8, "Alysrazor (Normal)", 250, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Alysrazor (Heroic)", 500, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Beth'tilac (Normal)", 250, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Beth'tilac (Heroic)", 500, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Lord Rhyolith (Normal)", 250, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Lord Rhyolith (Heroic)", 500, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Shannox (Normal)", 250, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Shannox (Heroic)", 500, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Baleroc (Normal)", 400, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Baleroc (Heroic)", 800, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Majordomo Staghelm (Normal)", 400, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Majordomo Staghelm (Heroic)", 800, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Ragnaros (Normal)", 400, zone.Firelands)
      REP_AddMob(1204, 4, 8, "Ragnaros (Heroic)", 800, zone.Firelands)
    end
